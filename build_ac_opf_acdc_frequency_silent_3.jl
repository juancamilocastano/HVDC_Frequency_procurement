function build_ac_opf_acdc_frequency_silent_3!(m::Model)
  ...
  #Initial status generators (unit commitment)
    ...
    m.ext[:constraints][:up_and_down_4]=@constraint(m, [g in G, k in 2:NT], zg[g, Tlabels[k-1]] - zg[g, Tlabels[k]] + betag[g, Tlabels[k]] - gammag[g, Tlabels[k]] == 0)#3.23
...
# Electrolyzer constraints
  ...
  m.ext[:constraints][:fcr_bound_gen]= @constraint(m, [g in G, t in T],
    ...
    rg_pos[g,t,c] <= 0.2*pmax[g]*zg[g,t]
    )    
