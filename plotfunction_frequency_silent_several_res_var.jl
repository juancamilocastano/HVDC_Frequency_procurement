function plotfunction_frequency_silent_several_res_var!(m::Model)
...
rhvdc9 = vec(sum(rhvdc_lc1vec, dims=1))
...
rhvdc10 = vec(sum(rhvdc_lg1vec, dims=1))
...
rhvdc11 = vec(sum(rhvdc_lc2vec, dims=1))
...
rhvdc12 = vec(sum(rhvdc_lg2vec, dims=1))
...
ax23=fig23[1, 1] = Axis(fig23,
    title = "Reserve per converter plg",
    xlabel = "Time (hours)",
    ylabel = "Power (MW)"
)
lines!(ax23, rhvdc_lg1vec[1,:], label = "Reserve Converter 2")
lines!(ax23, rhvdc_lg1vec[2,:], label = "Reserve Converter 3")
lines!(ax23, rhvdc_lg2vec[1,:], label = "Reserve Converter 1")
lines!(ax23, rhvdc_lg2vec[2,:], label = "Reserve Converter 4")
...
save("2_Reserve per converter plg.png",fig23)
end
