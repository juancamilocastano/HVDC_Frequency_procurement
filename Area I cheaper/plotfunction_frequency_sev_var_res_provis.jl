...
lines!(ax27, rhvdc_lg1vec[1,:], label = "Reserve Converter 2")
lines!(ax27, rhvdc_lg1vec[2,:], label = "Reserve Converter 3")
lines!(ax27, rhvdc_lc1vec[1,:], label = "Reserve Converter 2")
lines!(ax27, rhvdc_lc1vec[2,:], label = "Reserve Converter 3")
...
lines!(ax28, rhvdc_lg2vec[1,:], label = "Reserve Converter 1")
lines!(ax28, rhvdc_lg2vec[2,:], label = "Reserve Converter 4")
lines!(ax28, rhvdc_lc2vec[1,:], label = "Reserve Converter 1")
lines!(ax28, rhvdc_lc2vec[2,:], label = "Reserve Converter 4")
